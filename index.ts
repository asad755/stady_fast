...
class Student {
    ...
    static fromFile() {
        ...
        return JSON.parse(data).map((student: any) => new Student(student.suserName, student.spassword, student.section, student.id));
    }
...
class Lecturer {
    ...
    static fromFile() {
        ...
        return JSON.parse(data).map((lecturer: any) => new Lecturer(lecturer.userName, lecturer.password, lecturer.lecturerId));
    }
...
class AssignmentForAll {
    ...
    static fromFile() {
        ...
        return JSON.parse(data).map((assignment: any) => new AssignmentForAll(assignment.section, assignment.assignmentforall));
    }
    ...
    static searchDataInFile(section: string) {
        const assignments = AssignmentForAll.fromFile();
    ...
    static async updateSectionAssignment(section: string) {
        const assignments = AssignmentForAll.fromFile();
...
class AssignmentForOne {
    ...
    static fromFile() {
        ...
        return JSON.parse(data).map((assignment: any) => new AssignmentForOne(assignment.id, assignment.assignment));
    }
    ...
    static searchFromFile(id: number) {
        const assignments = AssignmentForOne.fromFile();
        assignments.forEach(assignment => {
            if (assignment.id === id) {
                assignment.display();
    ...
    static async updateAssignment(id: number) {
        const assignments = AssignmentForOne.fromFile();
